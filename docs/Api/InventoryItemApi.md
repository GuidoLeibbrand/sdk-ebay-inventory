# ld\php\sdkEbayInventory\InventoryItemApi
...
```php
bulkCreateOrReplaceInventoryItem($bulkInventoryItem): \ld\php\sdkEbayInventory\Model\BulkInventoryItemResponse
```
...
------------- | ------------- | ------------- | -------------
 **bulkInventoryItem** | [**\ld\php\sdkEbayInventory\Model\BulkInventoryItem**](../Model/BulkInventoryItem.md)| Details of the inventories with sku and locale |

### Return type

[**\ld\php\sdkEbayInventory\Model\BulkInventoryItemResponse**](../Model/BulkInventoryItemResponse.md)
...
```php
bulkGetInventoryItem($bulkGetInventoryItem): \ld\php\sdkEbayInventory\Model\BulkGetInventoryItemResponse
```
...
$bulkGetInventoryItem = new \ld\php\sdkEbayInventory\Model\BulkGetInventoryItem(); // \ld\php\sdkEbayInventory\Model\BulkGetInventoryItem | Details of the inventories with sku and locale

try {
    $result = $apiInstance->bulkGetInventoryItem($bulkGetInventoryItem);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bulkGetInventoryItem** | [**\ld\php\sdkEbayInventory\Model\BulkGetInventoryItem**](../Model/BulkGetInventoryItem.md)| Details of the inventories with sku and locale |

### Return type

[**\ld\php\sdkEbayInventory\Model\BulkGetInventoryItemResponse**](../Model/BulkGetInventoryItemResponse.md)
...
```php
bulkUpdatePriceQuantity($bulkPriceQuantity): \ld\php\sdkEbayInventory\Model\BulkPriceQuantityResponse
```
...
$bulkPriceQuantity = new \ld\php\sdkEbayInventory\Model\BulkPriceQuantity(); // \ld\php\sdkEbayInventory\Model\BulkPriceQuantity | Price and allocation details for the given SKU and Marketplace

try {
    $result = $apiInstance->bulkUpdatePriceQuantity($bulkPriceQuantity);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **bulkPriceQuantity** | [**\ld\php\sdkEbayInventory\Model\BulkPriceQuantity**](../Model/BulkPriceQuantity.md)| Price and allocation details for the given SKU and Marketplace |

### Return type

[**\ld\php\sdkEbayInventory\Model\BulkPriceQuantityResponse**](../Model/BulkPriceQuantityResponse.md)
...
```php
createOrReplaceInventoryItem($contentLanguage, $sku, $inventoryItem): \ld\php\sdkEbayInventory\Model\BaseResponse
```
...
$inventoryItem = new \ld\php\sdkEbayInventory\Model\InventoryItem(); // \ld\php\sdkEbayInventory\Model\InventoryItem | Details of the inventory item record.

try {
    $result = $apiInstance->createOrReplaceInventoryItem($contentLanguage, $sku, $inventoryItem);
    print_r($result);
} catch (Exception $e) {
 ...
 **inventoryItem** | [**\ld\php\sdkEbayInventory\Model\InventoryItem**](../Model/InventoryItem.md)| Details of the inventory item record. |
...
```php
getInventoryItem($sku): \ld\php\sdkEbayInventory\Model\InventoryItemWithSkuLocaleGroupid
```
...
[**\ld\php\sdkEbayInventory\Model\InventoryItemWithSkuLocaleGroupid**](../Model/InventoryItemWithSkuLocaleGroupid.md)
...
```php
getInventoryItems($limit, $offset): \ld\php\sdkEbayInventory\Model\InventoryItems
```
...
[**\ld\php\sdkEbayInventory\Model\InventoryItems**](../Model/InventoryItems.md)
