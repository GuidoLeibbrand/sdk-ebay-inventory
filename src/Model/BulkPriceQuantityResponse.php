...
class BulkPriceQuantityResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'responses' => '\ld\php\sdkEbayInventory\Model\PriceQuantityResponse[]'
    ];
     ...
     * Gets responses
     *
     * @return \ld\php\sdkEbayInventory\Model\PriceQuantityResponse[]|null
     */
     ...
     * Sets responses
     *
     * @param \ld\php\sdkEbayInventory\Model\PriceQuantityResponse[]|null $responses This container will return an HTTP status code, offer ID, and SKU value for each offer/inventory item being updated, as well as an <strong>errors</strong> and/or <strong>warnings</strong> container if any errors or warnings are triggered while trying to update those offers/inventory items.
     *
     * @return self
     */
