...
class ShipToLocationAvailabilityWithAll implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'allocationByFormat' => '\ld\php\sdkEbayInventory\Model\FormatAllocation',
        'availabilityDistributions' => '\ld\php\sdkEbayInventory\Model\AvailabilityDistribution[]',
        'quantity' => 'int'
    ];
     ...
     *
     * @return \ld\php\sdkEbayInventory\Model\FormatAllocation|null
     */
     ...
     *
     * @param \ld\php\sdkEbayInventory\Model\FormatAllocation|null $allocationByFormat allocationByFormat
     *
     * @return self
     */
     ...
     *
     * @return \ld\php\sdkEbayInventory\Model\AvailabilityDistribution[]|null
     */
     ...
     *
     * @param \ld\php\sdkEbayInventory\Model\AvailabilityDistribution[]|null $availabilityDistributions This container is used to set the available quantity of the inventory item at one or more warehouse locations.<br /><br /> This container will be returned if the available quantity is set for one or more inventory locations.
     *
     * @return self
     */
