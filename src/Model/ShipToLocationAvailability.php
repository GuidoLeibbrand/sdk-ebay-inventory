...
class ShipToLocationAvailability implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param \ld\php\sdkEbayInventory\Model\AvailabilityDistribution[]|null $availabilityDistributions This container is used to set the available quantity of the inventory item at one or more warehouse locations.<br><br> This container will be returned if available quantity is set for one or more inventory locations.
     *
     * @return self
     */
