...
class Offers implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'limit' => 'int',
        'next' => 'string',
        'offers' => '\ld\php\sdkEbayInventory\Model\EbayOfferDetailsWithAll[]',
        'prev' => 'string',
        'size' => 'int',
        'total' => 'int'
    ];
     ...
     * Gets offers
     *
     * @return \ld\php\sdkEbayInventory\Model\EbayOfferDetailsWithAll[]|null
     */
     ...
     * Sets offers
     *
     * @param \ld\php\sdkEbayInventory\Model\EbayOfferDetailsWithAll[]|null $offers This container is an array of one or more of the seller's offers for the SKU value that is passed in through the required <strong>sku</strong> query parameter.<br/><br/> <span class=\"tablenote\"> <strong>Note:</strong> Currently, the Inventory API does not support the same SKU across multiple eBay marketplaces, so the <strong>getOffers</strong> call will only return one offer.</span><br/><br/><strong>Max Occurs:</strong> 25
     *
     * @return self
     */
