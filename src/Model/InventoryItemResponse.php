...
class InventoryItemResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets errors
     *
     * @param \ld\php\sdkEbayInventory\Model\Error[]|null $errors This container will be returned if there were one or more errors associated with the creation or update to the inventory item record.
     *
     * @return self
     */
     ...
     * Sets statusCode
     *
     * @param int|null $statusCode The HTTP status code returned in this field indicates the success or failure of creating or updating the inventory item record for the inventory item indicated in the <strong>sku</strong> field. See the <strong>HTTP status codes</strong> table to see which each status code indicates.
     *
     * @return self
     */
     ...
     * Sets warnings
     *
     * @param \ld\php\sdkEbayInventory\Model\Error[]|null $warnings This container will be returned if there were one or more warnings associated with the creation or update to the inventory item record.
     *
     * @return self
     */
