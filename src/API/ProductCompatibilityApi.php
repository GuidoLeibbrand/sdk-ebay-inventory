...
class ProductCompatibilityApi
{
     ...
     * @param  \ld\php\sdkEbayInventory\Model\Compatibility $compatibility Details of the compatibility (required)
     *
     ...
     */
    public function createOrReplaceProductCompatibility($contentLanguage, $sku, $compatibility)
    {
        list($response) = $this->createOrReplaceProductCompatibilityWithHttpInfo($contentLanguage, $sku, $compatibility);
        return $response;
    }
     ...
     */
    public function createOrReplaceProductCompatibilityWithHttpInfo($contentLanguage, $sku, $compatibility)
    {
        $request = $this->createOrReplaceProductCompatibilityRequest($contentLanguage, $sku, $compatibility);
     ...
     */
    public function createOrReplaceProductCompatibilityAsync($contentLanguage, $sku, $compatibility)
    {
        return $this->createOrReplaceProductCompatibilityAsyncWithHttpInfo($contentLanguage, $sku, $compatibility)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createOrReplaceProductCompatibilityAsyncWithHttpInfo($contentLanguage, $sku, $compatibility)
    {
        $returnType = '\ld\php\sdkEbayInventory\Model\BaseResponse';
        $request = $this->createOrReplaceProductCompatibilityRequest($contentLanguage, $sku, $compatibility);
     ...
     */
    public function createOrReplaceProductCompatibilityRequest($contentLanguage, $sku, $compatibility)
    {
     ...
     * @throws \ld\php\sdkEbayInventory\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \ld\php\sdkEbayInventory\Model\Compatibility
     */
     ...
     * @throws \ld\php\sdkEbayInventory\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \ld\php\sdkEbayInventory\Model\Compatibility, HTTP status code, HTTP response headers (array of strings)
     */
    public function getProductCompatibilityWithHttpInfo($sku)
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\ld\php\sdkEbayInventory\Model\Compatibility' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\ld\php\sdkEbayInventory\Model\Compatibility', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\ld\php\sdkEbayInventory\Model\Compatibility';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\ld\php\sdkEbayInventory\Model\Compatibility',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
